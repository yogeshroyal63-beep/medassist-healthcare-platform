# -----------------------------------------------
# Severity Rules — All 45 Conditions
...
def get_severity(condition, age=None):
    ...
    Optionally applies age-based severity boosting.
    ...
    Returns:
        severity string: low / moderate / high / critical / unknown
    """
    ...
    if age >= 65:
        ...
        if upgraded:
            ...
            if SEVERITY_ORDER.get(upgraded, 0) > SEVERITY_ORDER.get(base_severity, 0):
                return upgraded
...
def get_care_advice(severity, condition):
    """
    Return care advice based on severity level.
    """
    advice = {
        "low": {
